  ...
  return (
    <>
      <Accordion title="1. [국가 과제] 코로나 펜데믹 완전극복과 피해소상공인에 대한 완전한 지원">
        ...
        채무조정 <br />
        - 방역조치로 인한 경영위축으로 인해 발생한 신용등급 하락을 회복하기 위한
        신용대사면 조치 단행
        <br />
        <br />
        ○ 이행기간
      ...
      <Accordion title="2. [경제, 산업] 수출 1조 달러, 국민소득 5만 달러 달성,주가지수 5000으로 세계5강 달성">
        ...
        ○ 이행방법
        <br />
        ■ 전환적 공정성장과 산업혁신으로 수출 1조 달러, 국민소득 5만 달러 달성,
        주가지수 5000 달성
        <br />
      ...
      <Accordion title="5. [복지, 안전] 어르신, 환자, 장애인, 아동, 영·유아 돌봄 국가책임제, 국민안심국가 실현">
        ...
        있도록 점진적으로 확대 추진 <br />- 기초연금 부부 감액 폐지 및 일하는
        어르신 국민연금 깎지 않고 지급 추진 <br />- 방문간호, 재택의료 서비스
        확대 등 어르신 요양 돌봄 서비스 강화 <br />
        - 치아 임플란트 건강보험 적용 확대, 어르신 주치의제 확대 <br />- 어르신
        일자리 80만 개에서 140만 개로 확대, 공익형 일자리 100만 개 확충 <br />{" "}
        <br />
        ■ 환자 돌봄의 국가 책임 강화로 가족부담 경감 <br />- 방문간호 및 방문
        의료 서비스 전국 확대 등 어르신 요양 돌봄 서비스 강화 <br />
        ...
        - 한부모 가족증명서 발급 소득 기준 폐지, 아동 양육비 지급 대상 소득 기준
        상향 <br /> <br />
        ...
        - 범죄경력자 관리·감독 강화하여 흉악범죄 재범률 하향 <br />- 범죄
        피해자에 대한 효율적 지원을 위한 전담 기구 설치 및 보호 기금 확충 <br />
        - 빅데이터·AI 등 첨단기술 활용 및 경찰 전담 인력 확대로 보이스피싱 박멸{" "}
        <br />
        - 자율방범대 등 민·관·경 유기적 협력을 통한 생활안전 역량 확충 <br />{" "}
        <br />
        ■ 자연 및 사회적 재난으로부터 안전한 사회 건설 <br />- 국가적 재난으로
        인한 대규모 손해 배상 및 보상을 위한 국가재난기금 설치 <br />- 통합
        기상재난예보 시스템 구축, 유해 물질 위협으로부터 국민건강 지킴 <br />
        ...
        - 임산부 친환경 꾸러미 공급, 어린이 과일 간식 및 취약계층 농식품 바우처
        사업 확대 <br />
        - ‘긴급끼니 돌봄’ 제도 도입 <br />
      ...
      <Accordion title="8. [문화, 정보통신] 문화강국 실현과 미디어산업 혁신성장">
        ...
        체육인 공제회 설립, 스포츠 클럽 활성화 <br />- 국민 여가관광권 추진,
        스마트관광 인프라 구축, 지역 강소 관광기업 육성 <br /> <br />
        ...
        ○ 이행기간 <br />- 2022년부터 관련 법 개정 등 제도 개선과 예산 확보 등을
        통해 추진 <br /> <br />
        ○ 재원조달방안 <br />
      ...
      <Accordion title="10. [국방, 통일, 외교] 스마트강군 건설, 실용외교로 평화안보 실현">
        ...
        스냅백(약속위반시 제재복원)과 단계적 동시행동, 국제협력강화, 신뢰조성 및
        적대해소를 통한 협상 여건 조성
        <br />
        - 첨단산업 중심의 한반도 평화경제 대전환 추진: 접경지역 글로벌 평화경제
        클러스터 조성, 글로벌 공급망 남북협력 추진
        <br />
        - 국민과 함께하는 남북협력 추진: 국민공감 대북정책 제도화, 청년세대 남북
        교류협력 추진
        <br />
        <br />
        ○ 이행기간
...
export default LeeAccordionList;
